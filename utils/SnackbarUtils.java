...
public final class SnackbarUtils {
    ...
    /**
     * Set the widthMargin margin.
     *
     * @param widthMargin The size of bottom margin, in pixel.
     */
    public SnackbarUtils setWidthMargin(@IntRange(from = 1) final int widthMargin) {
